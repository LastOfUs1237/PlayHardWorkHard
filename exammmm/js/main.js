$(document).ready(function() {
    ...
    let slider_1 = $('#slider_section1').lightSlider({
        item: 1,
        loop: true,
        auto: true,
    ...
    let slider = $('#slider_wrap').lightSlider({
        item: 3,
        loop: true,
        slideMargin: 30,
        responsive: [
...
function initMap() {
    ...
    let map = L.map('map').setView([46.96080629911459, 32.02012915353643], 16);

    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    }).addTo(map);

    L.marker([46.96080629911459, 32.02012915353643]).addTo(map)
        .bindPopup('BeetRoot')
